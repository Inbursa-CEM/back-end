...
class CursoController extends AbstractController {
    ...
    protected initializeRoutes(): void {
        ...
        this.router.post("/modificarAsignacion", this.postModificarAsignacion.bind(this));
    ...
    private async postDesasignarCurso(req: Request, res: Response) {
        try {
            const desasignacion = await db.Usuario_Curso.destroy({
                where: {
    ...
    private async postModificarAsignacion(req: Request, res: Response) {
        try {
            ...
            const newAsignacion = await db.Usuario_Curso.update(
                {
